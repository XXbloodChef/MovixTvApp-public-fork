...
(function() {
  ...
  // --- Bloqueur de publicités natif ---
  // Les réglages React Native sont inaccessibles sur la TV (barre d'outils
  // masquée) : la page /tvapp/settings du site pilote le bloqueur par ici.
  window.movixNativeAdBlock = {
    getState: function() {
      return bridgeRequest({ type: 'ADBLOCK_STATE' });
    },
    setEnabled: function(enabled) {
      return bridgeRequest({ type: 'ADBLOCK_SET', value: !!enabled });
    }
  };
