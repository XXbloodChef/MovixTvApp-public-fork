...
function loadBridge(pipOverrides = {}, runtimeOverrides = {}) {
  ...
  const require = id => {
    ...
    if (id === '../config') return { DEV_SITE_URL: null };
    if (id === './tvBack') return { clearBackInterception: () => {}, requestBackInterceptionResync: () => {}, setBackInterception: () => {} };
    if (id === './adBlock') {
      return { getAdBlockStats: async () => ({}), setAdBlockEnabled: async () => {} };
    }
