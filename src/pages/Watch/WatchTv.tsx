...
const WatchTv: React.FC = () => {
  ...
  const [, setPrefsVersion] = useState<number>(0);
  useEffect(() => {
  ...
  useEffect(() => {
    // Sur téléviseur, aucun popup publicitaire : le clic sur un lien externe
    // qu'il exige est impossible à la télécommande, et la lecture resterait
    // bloquée derrière `adPopupTriggered`.
